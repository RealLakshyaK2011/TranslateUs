...
namespace LibreTranslate.Net
{
    public class LibreTranslate
    {
        ...
        public async Task<IEnumerable<SupportedLanguages>> GetSupportedLanguagesAsync()
        {
            ...
            return JsonSerializer.Deserialize<IEnumerable<SupportedLanguages>>(await HttpClient.GetStringAsync("/languages"));
        }
        /// <summary>
        ...
        /// <returns></returns>
        public async Task<TranslationResponse> TranslateAsync(Translate translate)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var translatedText = JsonSerializer.Deserialize<TranslationResponse>(res);

                TranslateUsPlugin.LogLine("Recieved resp: \n" + res + "\nDesirializedText: " + translatedText.translatedText);
